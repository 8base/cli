...
it("As a user, I can create new property", async () => {
  ...
  await ((await page.waitForXPath(`//*[contains(@id, "react-select")][contains(text(), "Closing")]`)) as ElementHandle).click();
  await ((await page.waitForXPath(`//form//*[@name="listings"]`)) as ElementHandle).click();
  await ((await page.waitForXPath(`//*[contains(@id, "react-select")][contains(text(), "Lead")]`)) as ElementHandle).click();
  ...
  await ((await page.waitForXPath(`//form//button/span[contains(text(), "Create Property")]`)) as ElementHandle).click();
...
it("As a user, I can edit property", async () => {
  ...
  await ((await page.waitForXPath(`//*[contains(text(), "Beladle")]/../..//*[contains(text(), "Edit")]`)) as ElementHandle).click();

  await (await page.waitForXPath(`//input[@name="title"]`)).type(" Other");

  expect((await (await page.waitForXPath("//form/..")) as ElementHandle).screenshot()).toMatchImageSnapshot();

  await ((await page.waitForXPath(`//form//button/span[contains(text(), "Update Property")]`)) as ElementHandle).click();
...
it("As a user, I can delete property", async () => {
  ...
  await ((await page.waitForXPath(`//*[contains(text(), "Beladle")]/../..//i`)) as ElementHandle).click();
  await ((await page.waitForXPath(`//*[contains(text(), "Beladle")]/../..//*[contains(text(), "Delete")]`)) as ElementHandle).click();

  expect((await (await page.waitForXPath("//form/..")) as ElementHandle).screenshot()).toMatchImageSnapshot();

  await ((await page.waitForXPath(`//form//button/span[contains(text(), "Delete Property")]`)) as ElementHandle).click();
