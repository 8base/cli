...
export default {
  "default": {
    ...
    "migration_create_describe": "Creates a new migration file",
    "migration_create_success": "Migration file successfully created",
    "migration_create_usage": "8base migration:create [OPTIONS]",
    "migration_name_already_used": "Migration name '{{- name }}' already used",

    "schema_migrate_running": "Running migration '{{- name }}'",
    "schema_migrate_undoing": "Undoing migration '{{- name }}'",

    "schema_drop_describe": "Drop user defined schema",
    "schema_drop_usage": "8base schema:drop",
    "schema_drop_confirm": "Are you sure you want to drop all user tables?",
    "schema_migrate_all_migrations_are_already_applied": "All migrations are already applied",
    "schema_migrate_describe": "Run pending migrations",
    "schema_migrate_status_all_migrations_are_already_applied": "All migrations are already applied",
    "schema_migrate_status_applied_migrations": "Applied migrations",
    "schema_migrate_status_cant_fetch_migration_meta_table": "Cant fetch migration meta table",
    "schema_migrate_status_describe": "List the status of all migrations",
    "schema_migrate_status_pending_migrations": "Pending migrations",
    "schema_migrate_status_usage": "8base migrate:status",
    "schema_migrate_undo_all_describe": "Revert all migrations ran",
    "schema_migrate_undo_all_usage": "8base migrate:undo:all",
    "schema_migrate_undo_describe": "Reverts a migration",
    "schema_migrate_undo_usage": "8base migrate:undo",
    "schema_migrate_usage": "8base migrate",
