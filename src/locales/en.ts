...
export default {
  default: {
    ...
    init_confirm_not_empty_dir:
      "Selected directory is not empty. Are you sure you want to continue?",
    ...
    logs_tail_failed:
      "Failed to establish connection... Please try again in a few minutes.",
     ...
     */
    function_with_name_already_defined:
      "Function with name {{- name}} already defined",
     ...
     */
    generate_app_describe:
      "Generate an app skeleton for a specific framework (framework availability: react)",
    ...
    generate_scaffold_template_describe:
      "Type of template (crud, create, edit, delete, table, index) ",
    generate_scaffold_depth_describe: "Depth of the generated query",
    generate_scaffold_withMeta_describe:
      "Include meta fields (createdAt, createdBy, updatedAt)",
    ...
    generate_scaffold_successfully_created:
      "{{- screenName }} was successfully created",
    generate_scaffold_was_not_created: "{{- screenName }} wasn't created",
    /**
     * Generate resolver related messages
     */
    generate_resolver_usage:
    ...
    generate_trigger_invalid_type:
      "Invalid trigger type, available types: `before` and `after`",
    generate_trigger_invalid_operation:
      "Invalid trigger operation, valid example: `Users.create`",
    /**
    ...
    generate_webhook_path_describe:
      "Path for the url (https:<endpoint>/<path>)",
    ...
    generate_mock_grettings:
      "Boom! Your new {{- name }} request mock has been successfully generated.",
    /**
    ...
    generate_plugin_grettings:
      "Boom! Your new {{- name }} plugin has been successfully generated.",
    /**
    ...
    plugin_successfully_install:
      "Plugin {{- name }} successfully installed to your project.",

    plugins_with_name_already_defined:
      "Plugin with name {{- name }} already defined",
    ...
    plugin_successfully_remove:
      "Plugin {{- name }} successfully removed from your project.",
    plugin_remove_plugin_not_found:
      "Plugin {{- name }} not found in your project.",

    plugin_list_plugin_info:
