...
export default {
  default: {
    ...
    migration_commit_file_does_not_exist: 'Migrations file with name "{{name}}" doesn\'t exist',
    migration_commit_in_project_mode: 'You cannot commit migrations in only-project mode.',
